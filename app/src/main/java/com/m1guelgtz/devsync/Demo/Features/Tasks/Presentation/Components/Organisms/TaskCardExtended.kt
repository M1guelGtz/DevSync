package com.m1guelgtz.templatecarsapi.Demo.Features.Tasks.Presentation.Components.Organisms
        ...
        Column(
            ...
            Row(
                ...
                AppIcon(
                    ...
                    tint = if (task.status == TaskStatus.DONE) Color.Green else MaterialTheme.colorScheme.outline
                )
            ...
            Row(
                ...
                CaptionText(text = "Actualizado: ${task.updatedAt}")
            }
            
            task.assignedTo?.let {
                Spacer(modifier = Modifier.height(8.dp))
                CaptionText(text = "Asignado a: $it")
            }
        }
    }
}
