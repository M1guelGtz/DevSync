...
class ProjectViewModel @Inject constructor(
    ...
    fun onEditDescChanged(desc: String) {
        _uiState.update { it.copy(editDesc = desc) }
    }

    fun initializeEditState(project: Project) {
    ...
    fun updateProject(projectId: String) {
        ...
        viewModelScope.launch {
            try {
                updateProjectUseCase(projectId, state.editName, state.editDesc)
                _uiState.update { it.copy(
